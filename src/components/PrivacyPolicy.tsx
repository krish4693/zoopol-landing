      ...
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 md:p-10">
          <div className="mb-6 md:mb-8 text-center">
            ...
            <p className="text-gray-600 text-sm md:text-base mt-2">Last Updated: November 27, 2025</p>
          </div>
          ...
          <div className="text-gray-700 text-base md:text-lg leading-relaxed">
            <div className="pt-2 mb-8 md:mb-12">
            ...
            <div className="space-y-12 md:space-y-16">
              <div id="info-we-collect" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6 mt-4">1. Information We Collect</h3>
              ...
              <div id="use-of-info" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">2. How We Use Your Information</h3>
                <ul className="list-disc marker:text-[#156BFC] pl-6 space-y-4">
                  <li className="pl-2">
              ...
              <div id="share-info" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">3. How We Share Your Information</h3>
              ...
              <div id="storage-security" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">4. Data Storage & Security</h3>
              ...
              <div id="choices-rights" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">5. Your Choices & Rights</h3>
                <ul className="list-disc marker:text-[#156BFC] pl-6 space-y-4">
                  <li className="pl-2">
              ...
              <div id="retention" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">6. Data Retention</h3>
                <p className="text-gray-600">
              ...
              <div id="children" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">7. Children’s Privacy</h3>
                <p className="text-gray-600">
                  Zoopol is not intended for users under the age of 18. If we discover underage usage, the account will be removed.
                </p>
              </div>

              <div id="external-payments" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">8. Third-Party Links & External Payments</h3>
                <p className="text-gray-600">
              ...
              <div id="changes" className="scroll-mt-24">
                <h3 className="text-gray-900 text-2xl md:text-3xl font-bold tracking-tight mb-6">9. Changes to This Policy</h3>
