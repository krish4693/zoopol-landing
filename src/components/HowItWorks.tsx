      ...
      <div className="container mx-auto">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 relative items-start">
                    ...
                    {currentSteps.map((step, index) => (
                      ...
                      >
                        <div className="flex-shrink-0 mb-6">
                            <div className="w-16 h-16 rounded-2xl bg-[#0A0F1C] border border-white/10 flex items-center justify-center shadow-xl">
                              {step.icon}
                            </div>
                        </div>
                        <div>
                          <h3 className="text-white mb-4 font-black text-3xl lg:text-4xl">
                            {step.title}
                          </h3>
                          <p 
              ...
              <div className="w-full lg:w-1/2 sticky top-32 lg:h-[75vh] min-h-[400px] flex items-center justify-center order-first lg:order-last mb-12 lg:mb-0">
                  <div className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-[4/5] rounded-[40px] overflow-hidden bg-[#0A0F1C] border border-white/10 shadow-2xl">
