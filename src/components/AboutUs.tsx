  ...
  return (
    <section id="about-us" className="py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-4xl">
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 md:p-10 backdrop-blur-sm">
          <div className="mb-6 md:mb-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              <Users className="w-6 h-6 text-brand-indigo" aria-hidden="true" />
              <h1 className="text-slate-900 text-3xl md:text-4xl font-semibold tracking-tight">About Us — Zoopol</h1>
            </div>
          </div>
          ...
          <div className="text-slate-600 text-base md:text-lg leading-relaxed">
            ...
            <h3 className="text-slate-900 text-2xl font-bold mt-10 mb-6">About Ocean Point Private Limited</h3>
            <p className="mb-6">
            ...
            <h3 className="text-slate-900 text-2xl font-bold mt-10 mb-6">What We Do</h3>
            <p className="mb-4">Through Zoopol, Ocean Point Private Limited provides:</p>
            <ul className="list-disc marker:text-brand-indigo pl-6 space-y-4 mb-6">
            ...
            <h3 className="text-slate-900 text-2xl font-bold mt-10 mb-6">Our Mission</h3>
            <p className="mb-6">
            ...
            <h3 className="text-slate-900 text-2xl font-bold mt-10 mb-6">Our Vision</h3>
            <p className="mb-6">
            ...
            <h3 className="text-slate-900 text-2xl font-bold mt-10 mb-6">Why Choose Zoopol</h3>
            <ul className="list-disc marker:text-brand-indigo pl-6 space-y-4 mb-10">
            ...
            <div className="pt-12 border-t border-gray-200 mt-12 text-slate-600">
              <h3 className="text-slate-900 text-xl font-bold mb-4">Contact Information</h3>
              <p className="mb-2"><strong className="text-slate-900">Ocean Point Private Limited</strong></p>
              <p className="mb-2">Email: <a href="mailto:zoopol.india@gmail.com" className="text-brand-indigo hover:underline">zoopol.india@gmail.com</a></p>
              <p className="mb-2">Website: <a href="https://www.zoopol.com/" target="_blank" rel="noopener noreferrer" className="text-brand-indigo hover:underline">https://www.zoopol.com/</a></p>
              <p className="mb-2">Phone: <a href="tel:7510339308" className="text-brand-indigo hover:underline">7510339308</a></p>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <button 
              ...
              className="text-brand-indigo hover:underline cursor-pointer bg-transparent border-none font-medium"
            >
              Back to top ↑
            </button>
          </div>
