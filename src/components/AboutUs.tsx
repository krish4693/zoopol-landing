        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6 md:p-10">
          <div className="mb-6 md:mb-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h1 className="text-gray-900 text-3xl md:text-4xl font-semibold tracking-tight">About Us — Zoopol</h1>
            </div>
          </div>
          ...
          <div className="text-gray-700 text-base md:text-lg leading-relaxed">
            ...
            <h3 className="text-gray-900 text-2xl font-bold mt-10 mb-6">About Ocean Point Private Limited</h3>
            <p className="mb-6">
            ...
            <h3 className="text-gray-900 text-2xl font-bold mt-10 mb-6">What We Do</h3>
            ...
            <h3 className="text-gray-900 text-2xl font-bold mt-10 mb-6">Our Mission</h3>
            <p className="mb-6">
            ...
            <h3 className="text-gray-900 text-2xl font-bold mt-10 mb-6">Our Vision</h3>
            <p className="mb-6">
            ...
            <h3 className="text-gray-900 text-2xl font-bold mt-10 mb-6">Why Choose Zoopol</h3>
            ...
            <div className="pt-12 border-t border-gray-100 mt-12 text-gray-700">
              <h3 className="text-gray-900 text-xl font-bold mb-4">Contact Information</h3>
              <p className="mb-2"><strong>Ocean Point Private Limited</strong></p>
